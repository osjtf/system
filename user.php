...
.group1-thq-thedateofissueandalsotimeofissue-elm { top: 1029.85px; left: 37.37px; width: 250px; height: 56px; display: flex; position: absolute; align-items: flex-start; }
...
.group1-thq-text-elm36 { top: 764.55px; left: 29.23px; color: rgba(0, 0, 0, 1); position: absolute; font-size: 12px; font-weight: 700; text-align: center; font-family: "Noto Sans Arabic", sans-serif; line-height: 23px; }
.group1-thq-text-elm39 { top: 815.17px; left: 55px; color: rgba(0, 0, 0, 1); position: absolute; font-size: 12px; font-weight: 700; font-family: "Times New Roman", serif; }
.group1-thq-text-elm40 { top: 838.91px; left: 108.35px; color: rgba(20, 0, 255, 1); position: absolute; font-size: 11px; font-weight: 700; text-decoration: underline; pointer-events: auto; font-family: "Times New Roman", serif; }
